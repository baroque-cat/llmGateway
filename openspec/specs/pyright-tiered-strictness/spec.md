# pyright-tiered-strictness

## Purpose

Defines a tiered pyright type-checking configuration for the llmGateway project: strict mode for core domain logic (`src/core/`, `src/config/`) and basic mode for all other source and test code. This eliminates ~3,500 false-positive strict-mode errors from test code while preserving rigorous type-checking where it matters most.
