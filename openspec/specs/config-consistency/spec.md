...
Config default values are consistent across all three tiers of the default system (hardcoded `defaults.py` dict, user YAML deepmerge, Pydantic `Field(default=…)`).
