...
The project SHALL split `.github/workflows/quality.yml` from a single monolithic job into 4 parallel jobs, each running the same pytest commands as the Makefile's process-isolation groups.
