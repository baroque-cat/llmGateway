...
The project SHALL provide a `test_security.py` root-level gatekeeper test that scans the repository for hardcoded secrets, tokens, and keys in source files.
