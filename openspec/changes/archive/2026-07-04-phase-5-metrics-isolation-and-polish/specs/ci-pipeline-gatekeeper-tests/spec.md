...
The project SHALL provide a `test_ci_pipeline.py` root-level gatekeeper test that performs detailed structural validation of `.github/workflows/quality.yml` beyond the basic checks in `test_boundary_compliance.py`.
