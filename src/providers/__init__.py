...
def get_provider(provider_name: str, config: ProviderConfig) -> IProvider:
    ...
    if not provider_class:
        raise ValueError(f"Unknown provider type: '{provider_type}' for instance '{provider_name}'. "
    ...
    logger.debug(f"Successfully created provider instance '{provider_name}' of type '{provider_type}'.")
