...
Also provides ``mock_run_keeper_dependencies`` — a fixture that patches
the 13 dependencies shared across test_keeper.py, test_keeper_export_jobs.py,
...
@pytest.fixture
def mock_run_keeper_dependencies() -> Generator[SimpleNamespace]:
